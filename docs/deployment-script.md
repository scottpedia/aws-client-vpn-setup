...
- You will be then interactively asked for **the friendly name of the deployment** and **which AWS region to deploy the server** along with a few other options. If your don't know which one to choose, just press **Enter** to use the default value(if applicable).
